    ...
    <div className="min-h-screen p-6 lg:p-10">
      ...
      {persons.length === 0 ? (
        <div className="card flex flex-col items-center justify-center py-20">
          <svg width="48" height="48" viewBox="0 0 48 48" fill="none" className="mb-4 opacity-15" style={{ color: "#6B83A8" }}>
          ...
          <h3 className="font-display text-xl font-light" style={{ color: "#6B83A8" }}>
            No clients registered
          </h3>
          <p className="text-xs mt-2" style={{ color: "#3D5070" }}>
                ...
                <div
                  ...
                  style={{
                    background: deficit > 0
                      ? "linear-gradient(180deg, #E05555, transparent)"
                      : surplus > 0
                        ? "linear-gradient(180deg, #2ECC8E, transparent)"
                        : "linear-gradient(180deg, #C8963C, transparent)",
                  }}
                />
                  ...
                  <div className="flex items-start gap-4 flex-1">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex flex-wrap gap-x-4 gap-y-1 mt-1.5">
                        {person.phone && (
                          <span className="text-xs flex items-center gap-1" style={{ color: "#6B83A8" }}>
                      ...
                      {person.notes && (
                        <p className="text-xs mt-1.5 font-mono" style={{ color: "#3D5070" }}>
                  ...
                  {s && (
                    <div className="flex gap-6 sm:text-right flex-shrink-0">
                      <div>
                        ...
                        <p className="font-mono text-sm font-medium" style={{ color: "#E05555" }}>
                      ...
                      <div>
                        ...
                        <p className="font-mono text-sm font-medium" style={{ color: "#2ECC8E" }}>
